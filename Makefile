...
# Generated by qmake (2.01a) (Qt 4.8.5) on: søn 23. feb 22:04:50 2014
# Project:  netcoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.5\bin\qmake.exe USE_UPNP=- USE_QRCODE=1 -o Makefile netcoin-qt.pro
#############################################################################
...
Makefile: netcoin-qt.pro  c:/Qt/4.8.5/mkspecs/win32-g++/qmake.conf c:/Qt/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_UPNP=- USE_QRCODE=1 -o Makefile netcoin-qt.pro
